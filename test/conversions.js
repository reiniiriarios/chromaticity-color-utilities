...
describe('conversions',() => {
    ...
    it('hsi to rgb',() => {
        ...
        rgbIsMagenta(color,127)
        let color2 = Color.from('hsi',[300,100,67,50]).to('rgb',{bitDepth: 10})
        rgbIsMagenta10(color2,512)
    })
    ...
    it('hsp to rgb',() => {
        ...
        rgbIsMagenta(color,127)
        let color2 = Color.from('hsp',[300,100,65,50]).to('rgb',{bitDepth: 10})
        rgbIsMagenta10(color2,512)
    })
    ...
    it('yiq to rgb',() => {
        ...
        let color3 = Color.from('yiq',[0.413, 0.2746, 0.5226],{normalized:false}).to('rgb')
